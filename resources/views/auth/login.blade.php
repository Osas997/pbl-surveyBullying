   ...
   <div class=" w-full sm:cointainer">
      <div class="flex justify-center items-center">
         <div
            ...
            <p class="text-center font-medium text-sm mb-8 text-gray-800">Masukan Username dan Password Akun Sekolah
               dibawah ini</p>
            ...
            <div id="toast-success"
               ...
               <div class="ml-3 text-sm font-normal">{{session('successAddSekolah')}}</div>
               <button type="button"
