...
<div class="w-full min-h-screen  overflow-x-hidden scroll-smooth pt-10 ">
    <div
        class="section-1 max-w-screen-xl mx-auto px-4 flex flex-col  md:justify-between md:flex-row-reverse md:gap-4 md:px-8 lg:px-10 lg:justify-around lg:gap-0">
