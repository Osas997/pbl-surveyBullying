...
<nav class="border-gray-200 dark:bg-gray-900 fixed w-screen z-10 transition-all ease">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{route('viewSekolah')}}"
                        class="block py-2 px-3 text-slate-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-600 duration-300 rounded md:bg-transparent md:p-0 dark:text-white md:dark:text-blue-500"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <a href="{{route('logout')}}"
                        class="block py-2 px-3 text-slate-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 duration-300 md:p-0">Logout</a>
                </li>
            </ul>
        </div>
    </div>
